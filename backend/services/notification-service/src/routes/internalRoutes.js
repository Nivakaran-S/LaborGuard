/**
 * internalRoutes.js — service-to-service routes for notification-service.
 *
 * Guarded by a shared `INTERNAL_SERVICE_SECRET` header. Only producer
 * microservices should call these — never an end user.
 */
